...
class GUInD:
    ...
    def make_button(self):
        ...
        # solve button
        self.bruteButton = tkinter.Button(text="Bruteforce", command=self.start_bruteforce, master=self.frame)
        ...
        self.DnCButton = tkinter.Button(text="DnC", command=self.start_DnC, master=self.frame)
